...
const rows = {
    5: {
      ...
      materials: {
        "profile": {
          data: {
            'Purification': { type: 'text', value: 'Purification of the product by vacuum distillation (19 Torr, 55 °C) afforded a colorless liquid(11.7 g, 88%).' },
            'Procedure': { type: 'text', value: '2‐Methylthiophene (10 ml, 0.10 mol) and N‐chlorosuccinimide (13.3 g, 0.1 mol) were added to a stirred solution of THF (30 ml) and acetic acid (30 ml). The suspension was stirred for 30 min at room temperature, then, after 1 h of heating at reflux, the cooled mixture was poured into a 3 M NaOH solution (30 ml). The organic phase was washed with a 3 M NaOH solution (3 × 300 ml), dried (Na2SO4), filtered and the solvent evaporated in vacuo to yield a slightly yellow liquid.' },
            'Hints': { type: 'text', value: 'b.p. 55 °C(19 Torr). \n1H NMR(300 M Hz, CDCl3): δ = 2.41 (s 3H), 6.52–6.53 (d, 1H), 6.68, 6.69 (d, 1H) ppm. ' },
            'NMR': { type: 'image', value: [
              './static/nmr.png',
