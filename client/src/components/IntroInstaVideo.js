                ...
                <Grid container spacing={0} >
                    <Grid item xs={12}>
                        <div style={{position: 'relative', margin: 'auto', minWidth: '100px', maxWidth: '120px', width: '25%'}}>
                            ...
                            <Avatar imgProps={{style: { borderRadius: '50%'}}} onClick={() => this.setState({activeStory: 0, openDialog: true})} alt="Remy Sharp" src={this.props.infoHighlightSrc} className={classes.avatar} />
                        </div>
                    </Grid>
                    <Grid item xs={12}>
