...
class NewRandevuWrapper extends React.Component {
    constructor(props) {
        ...
        this.state = {
          slugifiedName: this.props.match && this.props.match.params && this.props.match.params.diyetisyenUserName ? this.props.match.params.diyetisyenUserName : '',          
        }
    ...
    componentDidMount() {
      if (!this.isLoaded()) {
        this.props.getDietitianProfileBySlugifiedName(userId);
      }
    }
