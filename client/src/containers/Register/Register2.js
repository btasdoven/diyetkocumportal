          ...
          <AppBar elevation={0} position="static" className={classes.appBar}>
            <Toolbar className={classes.layoutToolbar}>
              <span edge="start" style={{display: 'flex'}}>
                ...
                <Typography variant="h6" style={{position: 'absolute', display: 'flex', alignItems: 'center', justifyContent: 'center', left:0, width: '100%', top: 0, height: '56px', fontWeight: 400, color: 'white', textAlign: 'center', fontFamily: 'Open Sans,sans-serif'}}>Diyetisyen Kaydı</Typography>
              </span>
